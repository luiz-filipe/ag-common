...
public class LongSimulationRunTest {
	public static void main(String[] args) {
		...
		simulation.scheduleEnvironmentExploredRenderer("long-explored-10.png", 
				10, TimeUnit.SECONDS);
		
		simulation.scheduleEnvironmentExploredRenderer("long-explored-20.png",
				20, TimeUnit.SECONDS);

		simulation.scheduleEnvironmentExploredRenderer("long-explored-40.png",
				40, TimeUnit.SECONDS);
		
		simulation.scheduleEnvironmentExploredRenderer("long-explored-80.png",
				80, TimeUnit.SECONDS);
		
		simulation.scheduleEnvironmentExploredRenderer("long-explored-160.png",
